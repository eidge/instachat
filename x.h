...
class Screen
{
	...
	private:
		static boost::recursive_mutex Screen_Mutex;
		//No copying
...
boost::recursive_mutex Screen::Screen_Mutex;
...
class IO_Buffer
{
	...
	public:
		...
		void push_back(int c) 
			{if(current_position = 255) throw InstaException("Connection Loss");
...
{		
	...
	public:
		Talk(): zone1(&screen, 0, 3, screen.get_max_x() * 3),
		...
		virtual ~Talk() { if(TalkSocket) {TalkSocket->close(); delete TalkSocket;} }
